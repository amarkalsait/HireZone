      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold">Hire Zone</h2>
            <p className="text-sm">© 2024 Amar Kalsait. All rights reserved.</p>
          </div>
          
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://github.com/amarkalsait" className="hover:text-gray-400" aria-label="Facebook">
            ...
            <a href="https://www.linkedin.com/in/amar-kalsait-9732aa248/" className="hover:text-gray-400" aria-label="LinkedIn">
